...
const Question = ({ mcqs, setScore, setQuestionNumber }) => {
    ...
    const [thatsRight] = useState(typeof Audio !== "undefined" && new Audio(`audio/thats right.mp3`));
    const [sike] = useState(typeof Audio !== "undefined" && new Audio(`audio/sike.mp3`));
    ...
    return (
        <>
            ...
            <div className={style.options}>
                ...
                <Reward ref={reward} type="confetti" config={{angle: 70}}>
